...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Advocate Rama Rao Immaneni | High Court Legal Counsel" },
      ...
      { name: "author", content: "Advocate Rama Rao Immaneni" },
      { property: "og:title", content: "Advocate Rama Rao Immaneni | High Court Legal Counsel" },
